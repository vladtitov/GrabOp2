...
var connections_main_1 = require("./connections-main");
var myRoutes = [
    { path: '', component: connections_main_1.ConnectionsMain },
];
var ConnectionsModule = (function () {
    ...
    ConnectionsModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                connections_main_1.ConnectionsMain
            ],
            providers: []
        }), 
...
exports.default = ConnectionsModule;
